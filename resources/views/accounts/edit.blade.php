    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form-horizontal" method="POST" action="{{ route('account_edit', $account) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select name="account_type_id" id="account_type" class="form-control" required>
                                    <option value="{{$account->account_type_id}}" selected>{{$account->type->name}}</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="date" type="date" class="form-control{{ $errors->has('date') ? ' is-invalid' : '' }}" name="date" value="{{ $account->date }}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="start_balance" type="number" class="form-control{{ $errors->has('start_balance') ? ' is-invalid' : '' }}" name="start_balance" value="{{ $account->start_balance }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="description" type="text" class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}" name="description" value="{{ $account->description }}"></textarea>
